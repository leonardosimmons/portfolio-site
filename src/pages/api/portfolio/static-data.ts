    ...
    [
      {
        ...
        mobileText: 'Project Astoria is a mock full-stack ecommerce store built in typescript. The UI was made using React and it is powered by a node/express backend API.',
        link: {
          demo: '',
